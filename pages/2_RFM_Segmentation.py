...
from utils import (
    load_data, apply_sidebar_filters,
    build_rfm, run_clustering, elbow_data, assign_segment_labels,
    SEGMENT_COLORS, SEGMENT_LABELS
)
...
if max_k < 2:
    ...
    with st.expander("📐 Choose number of clusters (Elbow method)", expanded=True):
        ...
        **Silhouette Score** — measures how well separated the clusters are (on a scale of 0 to 1).
        ...
        > 💡 Find where the elbow and silhouette peak agree. If they differ,
